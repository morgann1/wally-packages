...
| [SharedToolbar](https://github.com/morgann1/wally-packages/tree/main/modules/shared-toolbar) | `SharedToolbar = "morgann1/shared-toolbar@0.2.0"` | Cross-plugin Studio toolbar: multiple plugins share one toolbar via a BindableEvent medium. |
